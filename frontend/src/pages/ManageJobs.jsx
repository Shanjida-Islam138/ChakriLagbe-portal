...
const ManageJobs = () => {
  ...
  useEffect(() => {
    document.title = "ChakriLagbe - Job Portal | ManageJobs";
  }, []);
  ...
  return (
    <section>
      {loading ? (
        ...
        <div className="p-4 text-center text-green-500">No jobs found.</div>
      ) : (
        <div className="overflow-x-auto shadow rounded-lg border border-green-200">
          {" "}
              ...
              {manageJobData.reverse().map((job, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-500 text-center">
                    <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-green-50 text-green-600 font-medium">
                      {job.applicants || 0}
                    </span>
                  </td>
