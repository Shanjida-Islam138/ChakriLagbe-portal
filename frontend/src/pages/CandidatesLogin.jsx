    ...
    <>
      ...
      <div className="flex flex-col min-h-screen">
        <main className="flex-grow flex items-center justify-center">
          <div className="w-full max-w-md border border-gray-200 rounded-lg p-6 bg-white shadow-md">
            ...
            <form className="space-y-4" onSubmit={userLoginHandler}>
              <div className="border border-green-400 rounded flex items-center p-2.5 focus-within:ring-2 focus-within:ring-green-500 focus-within:border-transparent">
                ...
                <input
                  ...
                  className="w-full outline-none text-sm text-green-700 placeholder-green-400"
                  value={email}
              ...
              <button
                type="submit"
                disabled={loading}
                className={`w-full bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded transition flex justify-center items-center cursor-pointer ${
