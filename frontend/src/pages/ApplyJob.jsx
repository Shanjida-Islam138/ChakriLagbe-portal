...
const ApplyJob = () => {
      ...
      <div className="flex-1 mb-6 md:mb-0">
        ...
        <div className="flex flex-wrap items-center gap-4 text-gray-600">
          ...
          <div className="flex items-center gap-2">
            ...
            <span>
              CTC:{" "}
              {jobData?.salary ? kConverter.convertTo(jobData.salary) : "Not disclosed"}
            </span>
          </div>
        </div>
      </div>
  ...
  <div className="flex flex-col lg:flex-row gap-8">
    <div className="w-full lg:w-1/2 xl:w-2/3">
      <h1 className="text-2xl font-bold mb-6 text-gray-700">Job Description</h1>
      <div
    ...
    <div className="w-full lg:w-1/2 xl:w-1/3">
      <h2 className="text-xl font-semibold mb-4 text-gray-700">
        Other Jobs at <span className="text-green-600">{jobData?.companyId?.name || "Company"}</span>
      </h2>
      <div className="space-y-4">
        {noSimilarJobs ? (
          <p className="text-gray-600">No other jobs available at the moment.</p>
        ) : (
          jobs
            .filter(
              (job) =>
            ...
            .filter((job) => {
              const appliedJobsId = new Set(userApplication?.map((app) => app.jobId?._id));
