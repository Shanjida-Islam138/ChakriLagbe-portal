...
export const faqs = [
  {
    ...
    title: "Terms",
    description1:
      "All users of ChakriLagbe must provide accurate and complete information during account registration. Providing false or misleading information may lead to account suspension or termination.",
    description2:
      "Users are responsible for maintaining the confidentiality of their login credentials. ChakriLagbe is not liable for any unauthorized access caused by compromised credentials."
  },
  {
    id: 2,
    title: "Limitations",
    description1:
      "ChakriLagbe is intended solely for lawful recruitment and job searching purposes. Any misuse of the platform, including spamming, fraudulent postings, or illegal activities, is strictly prohibited.",
    description2:
      "ChakriLagbe does not guarantee job placement or employment. Users accept that all actions taken through the platform are at their own risk."
  },
  {
    id: 3,
    title: "Revisions and Errata",
    description1:
      "ChakriLagbe may update, correct, or revise information on the platform at any time. While we strive for accuracy, occasional errors may occur in job postings or platform content.",
    description2:
      "Users are encouraged to verify critical information independently. ChakriLagbe is not liable for decisions made based on outdated or incorrect information."
  },
  {
    id: 4,
    title: "Site Terms of Use Modifications",
    description1:
      "ChakriLagbe reserves the right to modify these Terms and Conditions at any time. Continued use of the platform constitutes acceptance of the updated terms.",
    description2:
      "It is the responsibility of users to review the Terms regularly. Major changes will be highlighted on the platform to ensure transparency."
  }
];
