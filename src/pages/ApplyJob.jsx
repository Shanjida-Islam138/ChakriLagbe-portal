    ...
    <>
      ...
      <div className="min-h-screen flex flex-col py-10 container px-4 sxl:px-20 mx-auto">
        <div className="bg-white text-black rounded-lg w-ful">
          <div className="flex justify-center md:justify-between flex-wrap gap-8 px-14 py-20 mb-6 text-white rounded-xl bg-[#0F0F0F] relative overflow-hidden">
            ...
            <div className="flex flex-col justify-center text-end text-sm max-md:mx-auto max-md:text-center">
              <button className="bg-[#00A88E] hover:bg-[#0F0F0F] px-6 py-2 rounded text-white m-1">Apply Now</button>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start">
            <div className="w-full lg:w-2/3">
              ...
              <button className="bg-[#00A88E] hover:bg-[#0F0F0F] px-6 py-2 rounded text-white mt-10 ">Apply Now</button>
            </div>
