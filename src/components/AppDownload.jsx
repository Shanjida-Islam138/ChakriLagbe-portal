...
const AppDownload = () => {
  return (
    <div className="container px-4 2xl:px-20 mx-auto my-20">
     <div className="relative bg-[#0F0F0F] p-12 sm:p-24 lg:p-32 rounded-xl">
        <div>
          <h1 className="text-2xl sm:text-4xl font-bold mv-8 max-w-md text-white">Download Mobile App For Better Experience</h1>
